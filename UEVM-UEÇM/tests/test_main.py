    ...
    def test_epias_json_cache_reuses_payload_without_token_or_http_request(self):
        ...
        try:
            with mock.patch.dict(
                main.os.environ,
                {
                    "CK_EPIAS_JSON_CACHE_DIR": str(cache_dir),
                    "CK_EPIAS_JSON_CACHE_ENABLED": "true",
                    "CK_EPIAS_JSON_CACHE_HISTORY_SECONDS": "86400",
                },
            ):
        ...
        try:
            with mock.patch.dict(
                main.os.environ,
                {
                    ...
                    "CK_EPIAS_JSON_CACHE_ENABLED": "true",
                    "CK_EPIAS_JSON_CACHE_HISTORY_SECONDS": "86400",
                    "CK_EPIAS_FORCE_REFRESH_MIN_SECONDS": "60",
                },
            ):
        ...
        try:
            with mock.patch.dict(
                main.os.environ,
                {
                    ...
                    "CK_EPIAS_JSON_CACHE_ENABLED": "true",
                    "CK_EPIAS_JSON_CACHE_HISTORY_SECONDS": "86400",
                    "CK_EPIAS_FORCE_REFRESH_MIN_SECONDS": "0",
                },
            ):
                client = CountingClient()
                self.assertEqual(client._post_json(endpoint, payload), {"call": 1})
