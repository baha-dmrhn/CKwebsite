(() => {
  ...
  function openPanel() {
    ...
    if (!panel) return;
    if (byId("tvLoading")) byId("tvLoading").classList.add("hidden");
    if (byId("tvSettingsToggle")) byId("tvSettingsToggle").checked = true;
  ...
  function closePanel() {
    ...
    const button = byId("tvSettings");
    if (!panel) return;
    if (byId("tvSettingsToggle")) byId("tvSettingsToggle").checked = false;
