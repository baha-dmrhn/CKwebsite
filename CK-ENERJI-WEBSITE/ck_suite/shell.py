"""Shared navigation, sidebars and footer for the CK Enerji modules."""
...
def suite_navigation(active: str = "") -> str:
    ...
    return (
        '<nav class="ck-suite-nav" aria-label="CK Enerji modülleri">'
...
def suite_footer(kind: str) -> str:
    ...
    return (
        ...
        '<div class="suite-footer-brand"><img src="/suite-assets/ck-logo-white.png?v=1" '
        'alt="CK Enerji"></div>'
        "<div>"
...
def module_sidebar(kind: str) -> str:
    if kind == "baraj":
        ...
        links = (
            ...
            ("#baraj-dam-history", "⌁", "Baraj Geçmişi"),
    ...
    return (
        ...
        '<span class="suite-side-logo"><img src="/suite-assets/ck-mark.png?v=3" '
        'alt="CK Enerji"></span>'
        "<div>CK Enerji</div></div>"
        ...
        '<span data-suite-user-initial>C</span>'
        '<b data-suite-user-email>CK Enerji Kullanıcısı</b></div></div>'
    )
