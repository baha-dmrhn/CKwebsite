...
class SuiteHttpTests(unittest.TestCase):
    ...
    def test_login_is_a_clean_shared_portal_page(self):
        ...
        self.assertIn('href="/suite-assets/icon-192.png?v=3"', html)
        self.assertIn('href="/favicon.ico?v=3"', html)
        self.assertIn(
            'href="/suite-assets/apple-touch-icon.png?v=3"',
            html,
        )
        ...
        self.assertEqual(status, 200)
        self.assertIn("ck-enerji-shell-v31", worker)
    ...
    def test_piyasa_page_paths_are_mounted_under_piyasa(self):
        ...
        self.assertIn(
            'href="/suite-assets/apple-touch-icon.png?v=3"', html
        )
    ...
    def test_consumption_page_and_assets_are_mounted_under_tuketim(self):
        ...
        self.assertIn('src="/tuketim/consumption.js?v=16"', html)
    ...
    def test_android_app_user_agent_receives_native_shell_styles(self):
        ...
        self.assertIn('href="/android-app.css?v=15"', html)
        self.assertIn('class="sidebar"', html)
        status, content, headers = self.get("/android-app.css?v=15")
        css = content.decode("utf-8")
        self.assertEqual(status, 200)
        ...
        self.assertIn("::-webkit-datetime-edit-fields-wrapper", css)
        ...
        for path in (
            ...
            with self.subTest(path=path):
                ...
                self.assertIn('href="/android-app.css?v=15"', module_html)
