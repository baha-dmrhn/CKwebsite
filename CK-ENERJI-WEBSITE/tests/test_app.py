...
class SuiteHttpTests(unittest.TestCase):
    ...
    def test_unchanged_static_asset_returns_not_modified(self):
        ...
        headers = {"Cookie": f"{APP.AUTH.cookie_name}={self.token}"}
        try:
            connection.request("GET", "/module-suite.css?v=62", headers=headers)
    ...
    def test_login_is_a_clean_shared_portal_page(self):
        ...
        self.assertIn('href="/suite-assets/icon-192.png?v=6"', html)
        self.assertIn('href="/favicon.ico?v=4"', html)
        self.assertIn(
            'href="/suite-assets/apple-touch-icon.png?v=6"',
            html,
        )
        ...
        self.assertEqual(status, 200)
        self.assertIn("ck-enerji-shell-v34", worker)
    ...
    def test_piyasa_page_paths_are_mounted_under_piyasa(self):
        ...
        self.assertIn(
            'href="/suite-assets/apple-touch-icon.png?v=6"', html
        )
    ...
    def test_baraj_inline_api_paths_are_mounted_under_baraj(self):
        ...
        self.assertIn('href="/module-suite.css?v=62"', html)
    ...
    def test_consumption_page_and_assets_are_mounted_under_tuketim(self):
        ...
        self.assertIn('href="/tuketim/consumption.css?v=12"', html)
        self.assertIn('src="/tuketim/consumption.js?v=17"', html)
    ...
    def test_android_app_user_agent_receives_native_shell_styles(self):
        ...
        self.assertIn('href="/android-app.css?v=16"', html)
        self.assertIn('class="sidebar"', html)
        status, content, headers = self.get("/android-app.css?v=16")
        css = content.decode("utf-8")
        self.assertEqual(status, 200)
        ...
        self.assertIn(".consumption-date-nav output", css)
        ...
        for path in (
            ...
            with self.subTest(path=path):
                ...
                self.assertIn('href="/android-app.css?v=16"', module_html)
    ...
    def test_tv_mode_and_command_center_assets_are_served(self):
        ...
        self.assertIn('href="tv.css?v=19"', html)
        self.assertIn('src="tv-settings.js?v=16"', html)
        self.assertIn('src="tv.js?v=14"', html)
