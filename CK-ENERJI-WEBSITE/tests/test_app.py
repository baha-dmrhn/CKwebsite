...
class SuiteHttpTests(unittest.TestCase):
    ...
    def test_login_is_a_clean_shared_portal_page(self):
        ...
        self.assertIn('href="/suite-assets/icon-192.png?v=4"', html)
        self.assertIn('href="/favicon.ico?v=4"', html)
        self.assertIn(
            'href="/suite-assets/apple-touch-icon.png?v=4"',
            html,
        )
        ...
        self.assertEqual(status, 200)
        self.assertIn("ck-enerji-shell-v32", worker)
    ...
    def test_piyasa_page_paths_are_mounted_under_piyasa(self):
        ...
        self.assertIn(
            'href="/suite-assets/apple-touch-icon.png?v=4"', html
        )
